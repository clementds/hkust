...
turtle.speed(2)                             # Set the speed of the process
...
for i in range(firework_count):
    ...
    #print(radius, number_of_direction)                          
